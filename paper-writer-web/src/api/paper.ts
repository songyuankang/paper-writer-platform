...
export interface DiscussionFramework { id:string; task_id:string; hypothesis_ids:string[]; finding_ids:string[]; evaluation_ids:string[]; sections:Record<string,unknown>; provider:string; status:"current"|"stale_source"; created_at:string; }
